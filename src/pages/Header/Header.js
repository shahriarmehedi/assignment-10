    ...
    if (showmenu) {
        menu =
            <div className="fixed bg-gray-900 top-0 left-0 w-4/5 h-full transition duration-500 shadow z-50">
                ...
                <h1 className="pt-10">{user?.displayName ? <button className="px-6 py-3  bg-green-400 rounded text-gray-800 hover:bg-white transition duration-300" onClick={logOut}>Log Out</button> : <NavLink to="/signup"><button
                    className="px-6 py-3  bg-green-400 rounded text-gray-800 hover:bg-white transition duration-300">SIGNUP</button></NavLink>}</h1>
            </div>
            ...
            <nav className=" bg-gray-900 text-white mx-auto overflow-x-hidden">
                <ul className="flex justify-between my-5 items-center">
                    ...
                    <div className="hidden md:flex">
                        ...
                        <li className="mx-5 hover:text-green-400 transition duration-300"> <NavLink to="/contact" activeStyle={{
                            fontWeight: "bold",
                            color: "#34D399"
                        }}><button className="py-3 ">CONTACT</button></NavLink> </li>
                        ...
                        <li className="lg:mx-10 lg:px-8 hidden md:flex">
                            {user?.displayName ? <button className="px-6 py-3  bg-green-400 rounded text-gray-800 hover:bg-white transition duration-300" onClick={logOut}>Log Out</button> : <NavLink to="/signup"><button
                                className="px-6 py-3  bg-green-400 rounded text-gray-800 hover:bg-white transition duration-300">SIGNUP</button></NavLink>}
                        </li>
                    </div>
                </ul>
            </nav>
